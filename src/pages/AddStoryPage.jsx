...
const AddStoryPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    payload.append("hasBackground", formData.hasBackground);
    payload.append("bgColor", formData.bgColor);
    payload.append("verticalPos", formData.verticalPos);
    payload.append("horizontalPos", formData.horizontalPos);
      ...
      <div>
        ...
        <div className="flex items-center gap-3 mb-6 space-y-1">
          ...
          >
            <ArrowLeft
              size={20}
              className="transition-colors duration-200 ease-in-out group-hover:text-hover-blue"
            />
          </div>
          {/* Content */}
          <div>

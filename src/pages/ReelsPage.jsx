...
const ReelsPage = () => {
  ...
  return (
    <div className="flex overflow-hidden relative justify-center items-center w-screen h-screen bg-slate-950">
      ...
      <div className="hidden absolute right-6 top-1/2 z-30 flex-col gap-3 -translate-y-1/2 md:flex">
        <button
          onClick={() => scroll("up")}
          className="p-3 text-white rounded-full border shadow-xl backdrop-blur-md transition-all duration-200 ease-out bg-slate-900/60 hover:bg-slate-800 hover:scale-110 hover:border-white/20 border-white/10 active:scale-90"
